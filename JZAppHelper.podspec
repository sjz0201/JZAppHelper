#
#  Be sure to run `pod spec lint JZAppHelper.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.source       = { :git => "https://github.com/sjz0201/JZAppHelper.git", :tag => "#{spec.version}" }
  ...
  spec.resources = 'JZAppHelper/Tools/pics/pics.xcassets'
